...
function TweetGraphContainer() {
  ...
  return (
    <div className="flex h-[275px] w-[1600px] flex-row bg-black px-[20px]">
      <div className="flex flex-grow flex-col">
        ...
        <div className="my-auto flex justify-between text-white">
          <p>
            To see your own Tweet history, follow{" "}
            <span className="font-bold text-green-400">@bhancock_io</span> and
            reply to any of his tweets with{" "}
            <span className="font-bold text-green-400">#BrandonHancock</span>{" "}
            then you&apos;ll receive a picture in your DM&apos;s
          </p>
          <p>
            Generated by{" "}
            <span className="font-bold text-green-400">@bhancock_io</span>
          </p>
        </div>
      </div>
    </div>
